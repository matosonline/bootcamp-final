...
?>
  ...
  <div class="row">
    <div class="col-4 mx-auto">
              <form class="cmxform" id="signupForm" action="../controllers/User_signup.php" method="post">
                  ...
                  <button type="submit" name="btn-save" class="btn btn-primary submit" value="submit">Submit</button>
              </form>
