...
$(document).ready(function(){
    ...
    if(!loggedIn){
     ...
     var url = 'https://templating-rickmatos.c9users.io/controllers/City_read.php';
 ...
 var url = 'https://templating-rickmatos.c9users.io/controllers/Role_read.php';
...
$("#loginButton").click(function (){
    ...
    if(loginEmail.length > 0 && loginPassword.length > 0){
        ...
        var url = 'https://templating-rickmatos.c9users.io/controllers/login.php';
